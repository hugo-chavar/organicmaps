...
import app.organicmaps.search.tranqueras.TranquerasSearchAdapter;
import app.organicmaps.search.tranqueras.TranquerasSearchEngine;
...
public class TranquerasSearchFragment
        extends BaseMwmFragment
        implements NativeSearchListener, CategoriesAdapter.CategoriesUiListener
{
  private long mLastQueryTimestamp;
  @NonNull
  private final List<HiddenCommand> mHiddenCommands = new ArrayList<>();
  private static final String TAG = TranquerasSearchFragment.class.getSimpleName();
  ...
  private class ToolbarController extends SearchToolbarController
  {
    ...
    {
      super(root, TranquerasSearchFragment.this.requireActivity());
    }
...
//      TODO HUGO aca arranca la busqueda. Tenemos que cambiar el motor de busqueda
  ...
  @NonNull
  private TranquerasSearchAdapter mSearchAdapter;
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
  {
    ...
    mSearchAdapter = new TranquerasSearchAdapter(this);
    readArguments();
...

  {
    ...
    TranquerasSearchEngine.INSTANCE.addListener(this);
  ...
  public void setQuery(String text, boolean isCategory) { mToolbarController.setQuery(text, isCategory); }
  ...
  public void showSingleResultOnMap(@NonNull SearchResult result, int resultIndex)
  {
